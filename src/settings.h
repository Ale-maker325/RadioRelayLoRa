 ...
 *                     |                   | Это происходит потому, что при падении напряжения на линии питания или из-за разброса параметров самого кварца, 1.8V
 *                     |                   | оказывается на грани порога запуска. 2.4V — это «золотая середина», которая гарантирует старт генератора на большинстве
 ...
 *                     |                   | но для большинства SX126x внешних модулей 1.8V — стандарт, а для мощных Ebyte — часто 2.4V. 
